all: rna_compare5 rna_compare6 rna_compare8 
...
rna_compare8: fastalignment.8.cc fastalignment.8.h fatest6.cc filebuffer.cc stack.cc stockholmbuffer.cc  weight3.h stk_profile.cc queue.o simple_queue.cc simple_queue.h queue.cc
	g++ -w  -Wno-deprecated -pthread -lpthread -o rna_compare8 fastalignment.8.cc filebuffer.cc stack.cc stockholmbuffer.cc fatest6.cc stk_profile.cc simple_queue.cc queue.cc
