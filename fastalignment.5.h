...
class  Alignment{
public:
	Alignment(char *s1, int *st1, char *s2, int l1, int l2, char* n1, char* n2, char* sIn);
	~Alignment();
	...
	void toStokFile(char* fname, char *A, char *B, int *SS, int M, int N, int *S, int AP, int BP, char* n2);
